...
if(isset($_POST['submit'])) {
	...
	if (empty($errors) === true) {
		...
		$users->description = htmlentities(trim($_POST['description']));
                ...
                $users->price4 = htmlentities(trim($_POST['price4']));
                $users->price5 = htmlentities(trim($_POST['price5']));
...
<form class="form-horizontal"  action="" method="POST">
					...
					<label class="control-label col-md-2" for="description">Ingrediente</label>
                                        ...
                                        <div class="form-group">
                                        	<label class="control-label col-md-2" for="price">Pret 25 cm</label>
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                        	<label class="control-label col-md-2" for="price2">Pret 32 cm</label>
                                            <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                        	<label class="control-label col-md-2" for="price3">Pret 40 cm</label>
                                            <div class="col-md-4">
                                          ...
                                          <div class="form-group">
                                        	<label class="control-label col-md-2" for="price4">Pret 45 cm</label>
                                            <div class="col-md-4">
                                               <input type="text"  class="form-control" id="price" name="price4" maxlength="30" />
					   </div>
                                        </div>
                                          
                                          <div class="form-group">
                                        	<label class="control-label col-md-2" for="price5">Pret Party</label>
                                            <div class="col-md-4">
                                               <input type="text"  class="form-control" id="price" name="price5" maxlength="30" />
					   </div>
                                        </div>
